...
# Use teammate repo's YOLO model
YOLO_WEIGHTS = os.getenv("YOLO_WEIGHTS", str(REPO_ROOT / "models" / "yolo" / "best.pt"))
...
@lru_cache(maxsize=1)
def get_classifier():
    from mgrandhi.retrieval.swin_faiss import load_swin_faiss_classifier
